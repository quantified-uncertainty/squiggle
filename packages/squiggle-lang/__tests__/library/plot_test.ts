...
Was given arguments: ((x,y) => internal code)`
    ...
    testPlotResult(
      ...
      "numericFn",
      (plot) => {
        expect(plot.xScale.scaleShift?.type).toBe("linear");
    ...
    testPlotResult(
      ...
      "numericFn",
      (plot) => {
        expect(plot.xScale.scaleShift?.type).toBe("log");
        expect(plot.xScale.min).toBe(3);
        expect(plot.xScale.max).toBe(5);
      }
    );
    ...
    testPlotResult(
      ...
      "numericFn",
      (plot) => {
        expect(plot.xScale.scaleShift?.type).toBe("symlog");
        expect(plot.xScale.min).toBe(3);
        expect(plot.xScale.max).toBe(5);
      }
    );
...
Was given arguments: ((x,y) => internal code)`
  ...
  testPlotResult(
    ...
    "distFn",
    (plot) => {
      expect(plot.xScale.scaleShift?.type).toBe("date");

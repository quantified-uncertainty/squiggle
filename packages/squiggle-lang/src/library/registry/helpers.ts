...
export class FnFactory {
  ...
  n2n({
    ...
    return this.make({
      ...
      output: "Number",
      definitions: [
        makeDefinition([frNumber], ([x]) => vNumber(fn(x)), frNumber),
      ],
    });
  }
  ...
  bb2b({
    ...
    return this.make({
      ...
      output: "Bool",
      definitions: [
        makeDefinition([frBool, frBool], ([x, y]) => vBool(fn(x, y)), frBool),
      ],
    });
  }
  ...
  d2s({
    ...
    return this.make({
      ...
      definitions: [
        makeDefinition(
          [frDist],
          ([dist], { environment }) => vString(fn(dist, environment)),
          frString
        ),
      ],
    });
  ...
  d2n({
    ...
    return this.make({
      ...
      definitions: [
        makeDefinition(
          [frDist],
          ([x], { environment }) => vNumber(fn(x, environment)),
          frNumber
        ),
      ],
    });
  ...
  d2b({
    ...
    return this.make({
      ...
      definitions: [
        makeDefinition(
          [frDist],
          ([x], { environment }) => vBool(fn(x, environment)),
          frBool
        ),
      ],
    });
  ...
  d2d({
    ...
    return this.make({
      ...
      definitions: [
        makeDefinition(
          [frDist],
          ([dist], { environment }) => vDist(fn(dist, environment)),
          frDist
        ),
      ],
    });
...
function createComparisonDefinition<T>(
  ...
  return fnFactory.make({
    ...
    definitions: [
      makeDefinition(
        [frType, frType],
        ([d1, d2]) => vBool(comparisonFunction(d1, d2)),
        frBool
      ),
    ],
  });

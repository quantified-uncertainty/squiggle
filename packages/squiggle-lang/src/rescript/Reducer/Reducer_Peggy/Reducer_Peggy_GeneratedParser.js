...
function peg$parse(input, options) {
  ...
  var peg$f28 = function(number, unit) { 
      if (unit === null)
        { return number }
      else
  ...
  var peg$f29 = function() { return nodeInteger(parseInt(text()))};
  var peg$f30 = function() { return nodeFloat(parseFloat(text()))};
  var peg$f31 = function() { return nodeBoolean(text() === 'true')};
  var peg$f32 = function(args, statements, finalExpression) { statements.push(finalExpression) 
      	return nodeLambda(args, nodeBlock(statements)) };
  var peg$f33 = function(args, finalExpression) { return nodeLambda(args, nodeBlock([finalExpression])) };
  var peg$f34 = function() { return makeFunctionCall('$_constructArray_$', [nodeExpression([])])};
  var peg$f35 = function(args) { return makeFunctionCall('$_constructArray_$', [nodeExpression(args)])};
  var peg$f36 = function(args) { return makeFunctionCall('$_constructRecord_$', [nodeExpression(args)])};
  var peg$f37 = function(key, value) { return nodeKeyValue(key, value)};

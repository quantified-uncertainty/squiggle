...
function getCatalog(): Catalog {
  const items: Item[] = [
    ...
    { name: "Squiggle", id: "quri_squiggle", clusterId: "quri_software" },
    { name: "Foretold.io", id: "quri_foretold", clusterId: "quri_software" },
    {
    ...
    { name: "Ken", id: "quri_ken", clusterId: "quri_software" },
    { name: "Guesstimate", id: "quri_guesstimate", clusterId: "quri_software" },
  ];
...
quri_papers_1 = { funder_openphil_2020 * ss(20 to 20000) }

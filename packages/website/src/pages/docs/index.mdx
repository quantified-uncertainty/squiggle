...
<SquiggleEditor
  defaultCode={`/**
This means that you're 90% confident the value is between 8.1 and 8.4 Million.
*/
...
proportionOfPopulationWithPianos = {
  ...
  percentage * 0.01 // Final expression of a block is the block's value.
}
...
*/
totalTunersIn2022 // comment out this line with "//" to see other variables
`}
/>

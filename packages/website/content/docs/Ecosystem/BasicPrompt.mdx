...
You can read this document in plaintext [here](https://raw.githubusercontent.com/quantified-uncertainty/squiggle/refs/heads/main/packages/website/content/docs/Ecosystem/BasicPrompt.mdx).

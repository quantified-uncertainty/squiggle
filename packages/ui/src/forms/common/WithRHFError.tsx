  ...
  return (
    <div className="relative">
      ...
      {isErrorOpen && (
        ...
        >
          <div className="bg-red-100 fill-red-100 pr-4 pl-3 py-2 rounded flex gap-1 items-center shadow-md">
            <div
              className={clsx(
                "rotate-45 w-2 h-2 absolute left-3 bg-red-100",
                placement === "top-start" ? "-bottom-1" : "-top-1"
              )}
            />
            <ErrorIcon size={16} className="text-red-500 shrink-0" />

...
- If the outcome of a model is an extreme probability (less than 0.01 or more than 0.99), be suspicious of the result. It should be very rare for an intervention to have an extreme effect or have an extreme impact on the probability of an event.

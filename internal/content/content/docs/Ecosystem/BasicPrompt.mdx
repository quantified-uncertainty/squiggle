...
You can read this document in plaintext [here](https://raw.githubusercontent.com/quantified-uncertainty/squiggle/refs/heads/main/internal/content/content/docs/Ecosystem/BasicPrompt.mdx).
